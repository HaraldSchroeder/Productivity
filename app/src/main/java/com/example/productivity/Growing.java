...
public class Growing extends AppCompatActivity { // credit goes to: https://www.geeksforgeeks.org/how-to-create-a-stopwatch-app-using-android-studio/

    // Use seconds, running and wasRunning respectively
    // to record the number of seconds passed, whether the stopwatch is running and
